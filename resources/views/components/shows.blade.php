<section id="shows" class="py-20 bg-gray-800">
    <div class="container mx-auto px-6">
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="bg-gray-900 rounded-lg p-6 flex flex-col md:flex-row items-center">
                ...
                <div class="mb-4 md:mb-0 md:mr-6 w-full md:w-48 flex-shrink-0">
                    <img src="{{ asset('storage/'.$event->poster_path) }}" alt="{{ $event->name }}" class="rounded-lg w-full h-48 object-cover">
                </div>
                @endif
                ...
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('events.show', $event->id) }}" class="bg-primary hover:bg-blue-600 text-white px-6 py-2 rounded-full transition">
                        Lihat detail
                    </a>
                </div>
            </div>
        ...
        <div class="flex justify-center mt-12">
            <a href="{{ route('events.index') }}" class="bg-primary text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-600 transition duration-300">
                Lihat Selengkapnya
            </a>
        </div>
    </div>
